...
const grammarTopics = [
  { id: 1, title: "Present Simple", rules: [
  ...
  { id: 2, title: "Present Continuous", rules: [
  ...
  { id: 4, title: "Past Continuous", rules: [
  ...
  { id: 5, title: "Future Simple", rules: [
  ...
  { id: 6, title: "Future Continuous", rules: [
  ...
  { id: 7, title: "Present Perfect", rules: [
  ...
  { id: 8, title: "Present Perfect Continuous", rules: [
  ...
  { id: 10, title: "Past Perfect Continuous", rules: [
  ...
  { id: 11, title: "Future Perfect", rules: [
  ...
  { id: 12, title: "Future Perfect Continuous", rules: [
    ...
    <div className={`grammar-container ${darkMode ? "dark" : "light"}`}>
      ...
      {!selected && (
        <div className="grammar-menu">
          {grammarTopics.map(topic => (
            <div 
              key={topic.id} 
              className={`grammar-topic-btn ${selected === topic.id ? "active" : ""}`}
      ...
      {current && (
        <div className="grammar-content">
          ...
          <h2>{current.title}</h2>
          <ul>
            {current.rules.map((rule, idx) => <li key={idx}>{rule}</li>)}
          </ul>
